...
export const metadata = pageMeta({
  ...
  description:'Ask a focused question and cast a Vedic Prashna chart for the exact time and location. Free basic direction with complete Premium and Yearly member judgement and timing.',
  path:'/prashna',
