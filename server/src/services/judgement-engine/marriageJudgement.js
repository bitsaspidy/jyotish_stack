...
function _safeSummaryHi(score, sevLordHouse, venScore, domScore, sevPpk) {
  if (score >= 72) {
    ...
    return 'रिश्तों में विशेष सावधानी, धैर्य और परिपक्वता की जरूरत हो सकती है। संवाद, पारिवारिक सहभागिता और अहंकार प्रबंधन पर ध्यान देना जरूरी है। प्रयास और सही चुनाव से रिश्ते सार्थक और संतोषजनक हो सकते हैं।';
  } else {
