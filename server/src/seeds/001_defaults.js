  ...
  await knex('subscription_plans').insert([
    {
      name: 'Basic',
      name_hi: 'आधारभूत',
      description: 'Basic kundli and daily predictions — no PDF download',
      price: 200,
      currency: 'INR',
      duration_days: 30,
      features: JSON.stringify(['1 Kundli profile', 'Daily prediction', 'Basic matchmaking', 'No PDF download']),
      is_active: true,
    },
    {
      name: 'Premium',
      name_hi: 'प्रीमियम',
      description: 'Full kundli, dasha analysis, advanced predictions, and PDF download',
      price: 499,
      currency: 'INR',
      duration_days: 30,
      features: JSON.stringify(['5 Kundli profiles', 'PDF download', 'Daily/Weekly/Monthly predictions', 'Advanced matchmaking', 'Dasha analysis', 'Transit report']),
      is_active: true,
    },
    {
      name: 'Yearly',
